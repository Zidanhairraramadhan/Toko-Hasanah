document.addEventListener('DOMContentLoaded', async function() {
    ...
    try {
        ...
        const authResponse = await fetch('https://toko-hasanah-production.up.railway.app/api/check-auth', { credentials: 'include' });
    ...
    const API_URL = 'https://toko-hasanah-production.up.railway.app/api/products';
    ...
    logoutBtn.addEventListener('click', async () => {
        ...
        await fetch('https://toko-hasanah-production.up.railway.app/api/logout', { method: 'POST', credentials: 'include' });
        window.location.href = 'login.html';
    });
